...
その時点から、マルチシグアカウントは自分自身で取引を発表することができなくなります。マルチシグの共同署名者が、マルチシグを含む取引を提案し、それをAggregateTransaction（アグリゲートトランザクション）にラップする必要があります。
取引をブロックに記録するためには、他の共同署名者が同意する必要があります。
